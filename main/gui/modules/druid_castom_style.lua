...
M["scroll"] = {
	...
	BACK_SPEED = 0, -- Lerp speed of return to soft position
	FRICT = 0, -- mult for free inert
	FRICT_HOLD = 0, -- mult. for inert, while touching
	INERT_THRESHOLD = 0, -- speed to stop inertion
	INERT_SPEED = 0, -- koef. of inert speed
	EXTRA_STRETCH_SIZE = 0, -- extra size in pixels outside of scroll (stretch effect)
	POINTS_DEADZONE = 0, -- Speed to check points of interests in no_inertion mode
	--]]
	...
	WHEEL_SCROLL_SPEED = 15, -- Amount of pixels to scroll by one wheel event (0 to disable)
