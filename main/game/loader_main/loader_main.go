components {
  id: "loader_main"
  component: "/main/game/loader_main/loader_main.script"
  position {
    x: 0.0
    y: 0.0
    z: 0.0
...
embedded_components {
  id: "level_hospital_3_collectionproxy"
  type: "collectionproxy"
  data: "collection: \"/main/game/levels/levels/hospital/hospital_3/hospital_3.collection\"\n"
  "exclude: false\n"
  ""
  position {
    x: 0.0
...
embedded_components {
  id: "level_world_map_collectionproxy"
  type: "collectionproxy"
  data: "collection: \"/main/game/levels/levels/world_map/world_map.collection\"\n"
  "exclude: false\n"
  ""
  position {
    x: 0.0
