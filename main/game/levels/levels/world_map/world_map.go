...
components {
  id: "tilemap"
  component: "/main/game/levels/levels/world_map/world_map.tilemap"
  position {
    x: 0.0
    y: 0.0
    z: 0.0
...
components {
  id: "map_scripts"
  component: "/main/game/levels/levels/world_map/world_map.script"
  position {
    x: 0.0
    y: 0.0
    z: 0.0
...
embedded_components {
  id: "collisionobject1"
  type: "collisionobject"
  data: "collision_shape: \"/main/game/levels/levels/world_map/world_map.tilemap\"\n"
  "type: COLLISION_OBJECT_TYPE_STATIC\n"
  "mass: 0.0\n"
  "friction: 0.1\n"
  "restitution: 0.5\n"
