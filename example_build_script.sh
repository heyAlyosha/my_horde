...
#java -jar "${BUNDLE_DIR}/bob.jar" --email a@b.com --auth 123 --texture-compression true --bundle-output "${BUNDLE_DIR}/js-web" --platform js-web --archive --liveupdate yes --variant debug resolve build bundle
