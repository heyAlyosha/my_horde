...
mv build/liveupdate_output/*.zip build/bundle/${PLATFORM}/My Horde/resources.zip
# (cd build/bundle/${PLATFORM}/My Horde/ && http-server -c-)
--http-server -c-
...
#https://yandex.ru/games/app/160801?draft=true&game_url=https://localhost:8080/build/bundle/wasm-web/My Horde/